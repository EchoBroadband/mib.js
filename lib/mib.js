...
var MIB = function () {
    return ({
                            ...
                            case '::=': //new OBJECT to define
                                ...
                                if (Symbols[i + 1].indexOf('{') == 0) {
                                    ...
                                    if (Symbols[i - 1] == 'OBJECT IDENTIFIER') {
                                        var mibobj = {};
                                        Object[Symbols[i - 2]] = mibobj;
                                        mibobj['ObjectName'] = Symbols[i - 2];
                                        mibobj['ModuleName'] = ModuleName;
                                        mibobj['OBJECT IDENTIFIER'] = Symbols[i + 1].replace("{", "").replace("}", "").trim();
                                        if (mibobj['OBJECT IDENTIFIER'] == '0 0') {
                                            mibobj['OID'] = '0.0';
                                            mibobj['NameSpace'] = 'null';
                                        }
                                        else {
                                            this.OID(mibobj['OBJECT IDENTIFIER'], '', Symbols[i - 2], '', function (ID, OD) {
                                                mibobj['OID'] = ID;
                                                mibobj['NameSpace'] = OD;
                ...
                for (m = 0; m < M_len; m++) {
                    ...
                    for (o = 0; o < O_len; o++) {
                        if (this.Modules[Modules[m]][Objects[o]][stringtype] == string && !found) {
                            ...
                            if(!callback)
                                return this.Modules[Modules[m]][Objects[o]];
        ...
        LoadMIBs: function () {
            ...
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//RFC1155-SMI.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//RFC1158-MIB.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//SNMPv2-SMI.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//SNMPv2-CONF.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//SNMPv2-TC.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//SNMPv2-MIB.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//RFC-1212.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//RFC1213-MIB-II.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//IANAifType-MIB.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//IF-MIB.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//IP-FORWARD-MIB.MIB");

            this.Import(__dirname + "/../RFC_BASE_MINIMUM//BGP4-MIB.MIB");

            this.Import(__dirname + "/../RFC_BASE_MINIMUM//HOST-RESOURCES-MIB.MIB");

            this.Import(__dirname + "/../RFC_BASE_MINIMUM//CISCO-SMI.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//CISCO-TC.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//CISCO-PRODUCTS-MIB.MIB");

            this.Import(__dirname + "/../RFC_BASE_MINIMUM//OLD-CISCO-TCP-MIB.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//OLD-CISCO-TS-MIB.MIB");

            this.Import(__dirname + "/../RFC_BASE_MINIMUM//RMON-MIB.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//INET-ADDRESS-MIB.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//IP-MIB.MIB");

            this.Import(__dirname + "/../RFC_BASE_MINIMUM//SNMP-FRAMEWORK-MIB.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//CISCO-VTP-MIB.MIB");


            this.Import(__dirname + "/../RFC_BASE_MINIMUM//CISCO-CDP-MIB.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//CISCO-VLAN-MEMBERSHIP-MIB.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//CISCO-METRO-PHY-MIB.MIB");
            //TRAPS
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//CISCO-CONFIG-MAN-MIB.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//CISCO-SYSLOG-MIB.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//CISCO-IPSEC-FLOW-MONITOR-MIB.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//CISCO-IPSEC-MIB.MIB");
            this.Import(__dirname + "/../RFC_BASE_MINIMUM//CISCO-EIGRP-MIB.MIB");
        ...
        WriteToFile: function (fname) {
        	//__dirname +
        	fs.writeFile(__dirname + "/../RFC_BASE_MINIMUM/"+ fname, JSON.stringify(this.Modules, null, 4), function (err) {
                if (err) {
                    console.log(err);
                } else {
